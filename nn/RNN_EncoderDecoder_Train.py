...
from nn.RNN_EncoderDecoder_Dataset import PthDataset
...
def main():
    ...
    # data loader
    train_dataset = PthDataset(file_path='../data/rnn_encoderdecoder_train_set.pth')
    test_dataset = PthDataset(file_path='../data/rnn_encoderdecoder_test_set.pth')
    val_dataset = PthDataset(file_path='../data/rnn_encoderdecoder_validate_set.pth')
